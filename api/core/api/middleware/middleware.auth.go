...
type AuthManager struct {
	...
	Cache              *utility.Cache
	responseHandler    *handler.BaseHandler[models.User, dto.UserCreateInput, dto.UserChangeInfoInput]
}
...
func newAuthManager() (*AuthManager, error) {
	...
	newManager.responseHandler = &handler.BaseHandler[models.User, dto.UserCreateInput, dto.UserChangeInfoInput]{
...
func (am *AuthManager) getUserPermissions(userID string) (map[string]byte, error) {
	...
	// Kiểm tra cache, nếu có thì trả về ngay, không cần lấy từ database
