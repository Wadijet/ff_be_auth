...
type PcPosOrder struct {
	...
	OrderItems      []interface{}          `json:"orderItems" bson:"orderItems" extract:"PosData\\.order_items,optional"`                                               // Danh sách sản phẩm trong đơn hàng (extract từ PosData["order_items"])
