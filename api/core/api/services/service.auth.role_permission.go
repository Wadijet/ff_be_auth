...
func (s *RolePermissionService) Create(ctx context.Context, input *dto.RolePermissionCreateInput) (*models.RolePermission, error) {
	...
	if _, err := s.permissionService.FindOneById(ctx, permissionObjID); err != nil {
		return nil, common.ErrNotFound
	}
