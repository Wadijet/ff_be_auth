...
// - CreateInput: dto.AccessTokenCreateInput - Struct đầu vào cho việc tạo mới
// - UpdateInput: dto.AccessTokenUpdateInput - Struct đầu vào cho việc cập nhật
type AccessTokenHandler struct {
	BaseHandler[models.AccessToken, dto.AccessTokenCreateInput, dto.AccessTokenUpdateInput]
