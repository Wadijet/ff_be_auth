...
// - Model: models.FbPage
// - CreateInput: dto.FbPageCreateInput
// - UpdateInput: dto.FbPageCreateInput
...
//
// Request Body:
//   - dto.FbPageUpdateTokenInput: Thông tin token cần cập nhật
//
// Returns:
//   - error: Lỗi nếu có
//
...
func (h *FbPageHandler) HandleUpdateToken(c fiber.Ctx) error {
	input := new(dto.FbPageUpdateTokenInput)
